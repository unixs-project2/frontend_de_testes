...
// Cria o teste para a rota '/editar_fluxo':
// Pré-requisitos:
// - 

export const teste_rota_editar_fluxo = async () => {
	console.log("Entrou em: export const teste_rota_editar_fluxo = async () =>");
...
const teste = () => {
  ...
  return new Promise(resolve => { 	
		...
		fetch(internet_backend+"/editar_fluxo", {
		  method: 'POST',
		  headers: {
