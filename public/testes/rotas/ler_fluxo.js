...
// Cria o teste para a rota '/ler_fluxo':
// Pré-requisitos:
// - 

export const teste_rota_ler_fluxo = async () => {
	console.log("Entrou em: export const teste_rota_ler_fluxo = async () =>");
...
const teste = () => {
  ...
  return new Promise(resolve => { 	
		...
		fetch(internet_backend+"/ler_fluxo", {
		  method: 'POST',
		  headers: {
