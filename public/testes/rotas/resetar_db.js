...
// Cria o teste para a rota '/resetar_db':
// Pré-requisitos:
// - 
export const teste_rota_resetar_db = async () => {
	console.log("Entrou em: export const teste_rota_resetar_db = async () =>");
...
const teste = () => {
  ...
  return new Promise(resolve => { 	
		...
		fetch(internet_backend+"/resetar_db", {
		  method: 'POST',
		  headers: {
