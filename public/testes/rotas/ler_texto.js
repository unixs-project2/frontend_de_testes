...
// Cria o teste para a rota '/ler_texto':
// Pré-requisitos:
// - 

export const teste_rota_ler_texto = async () => {
	console.log("Entrou em: export const teste_rota_ler_texto = async () =>");
...
const teste = () => {
  ...
  return new Promise(resolve => { 	
		...
		fetch(internet_backend+"/ler_texto", {
		  method: 'POST',
		  headers: {
